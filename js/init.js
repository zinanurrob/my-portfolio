...
alert("If your'e viewing this website from mobile or tablet then please do not use your phone as landscape. because this website is not supportive in landscape. kindly view it in portrait mode. - from the website owner (zinanur rob)")
...
const firstSectionDescription = document.querySelector("hidden_content")

 firstSectionDescription.addEventListener("click", function (){

			firstSectionDescription.style.display = "none"
...
function kura_tm_cursor(){
	...
	if(myCursor.length){
        ...
        }), e.style.visibility = "visible", t.style.visibiliimagedescriptionty = "visible"
    }
	}
};
